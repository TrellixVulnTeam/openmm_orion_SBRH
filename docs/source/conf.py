...
latex_documents = [
    (master_doc, 'mdorion.tex', 'MDOrion Documentation',
     'OpenEye', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'mdorion', 'MDOrion Documentation',
     author, 'MDOrion', 'One line description of project.',
     'Miscellaneous'),
]
