...
job.add_cubes(iun, ibn, coll_open, coll_close, ofs_nes, ofs_abfe, fail)
...
input_port_dic = {'input_open_collection_port': coll_open.success, 'input_bound_port': ibn.success}
...
coll_close.success.connect(ofs_nes.intake)
